...
class Line:
    ...
    def _handle_arrival(self, message):
        ...
        logger.debug("Inside _handle_arrival")
        value = message.value()
    ...
    def process_message(self, message):
        ...
        if 'table' in message.topic(): # Set the conditional correctly to the stations Faust Table
            logger.info("Inside Faust table processing")
            try:
